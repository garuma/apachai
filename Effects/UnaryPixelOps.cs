...
namespace Apachai.Effects.Core
{
    ...
    public sealed class UnaryPixelOps
    {
        ...
        public class Identity
            : UnaryPixelOp
        {
            public override PixelData Apply (PixelData color)
            {
                return color;
            }
            ...
            {
                //Memory.Copy(dst, src, (ulong)length * (ulong)sizeof(PixelData));
            }

            public unsafe override void Apply(PixelData* ptr, int length)
            {
                return;
            }
        }
            ...
            : UnaryPixelOp
        {
            ...
            public Constant(PixelData setColor)
            {
            ...
            : UnaryPixelOp
        {
            ...
            public override PixelData Apply(PixelData color)
            {
                ...
                byte a2 = ComputeAlpha(255, 255);

                return PixelData.FromBgra((byte)b, (byte)g, (byte)r, a2);
            }

            public BlendConstant(PixelData blendColor)
            {
            ...
            : UnaryPixelOp
        {
            ...
            public override unsafe void Apply(PixelData* dst, PixelData* src, int length)
            {
                while (length > 0)
                {
                    *dst = *src;
            ...
            public override unsafe void Apply(PixelData* ptr, int length)
            {
                while (length > 0)
                {
        ...
        /// occupying the 8 most-significant-bits of a PixelData instance.
            ...
            : UnaryPixelOp
        {
            ...
            public override PixelData Apply(PixelData color)
            {
                return PixelData.FromUInt32((color.Bgra & 0x00ffffff) + addValue);
            }
            ...
            : UnaryPixelOp
        {
            public override PixelData Apply(PixelData color)
            {
                return PixelData.FromUInt32(color.Bgra | 0xff000000);
            }
            ...
            : UnaryPixelOp
        {
            public override PixelData Apply(PixelData color)
            {
                return PixelData.FromBgra((byte)(255 - color.B), (byte)(255 - color.G), (byte)(255 - color.R), 255);
            }
        }
            ...
            : UnaryPixelOp
        {
            ...
            public override PixelData Apply(PixelData color)
            {
                ...
                if ((difference > tolerence) && (saturation > 100)) 
                {
                    ...
                    return PixelData.FromBgra((byte)color.B,(byte)color.G, ib, 255);
                }
                else
                {
                    return color;
            ...
            private int GetSaturation(PixelData color)
            {
                double min;
                double max;
                double delta;
            ...
            : UnaryPixelOp
        {
            public override PixelData Apply(PixelData color)
            {
                return PixelData.FromBgra((byte)(255 - color.B), (byte)(255 - color.G), (byte)(255 - color.R), 0);
            }
        }
            ...
            : UnaryPixelOp
        {
            public override PixelData Apply(PixelData color)
            {
                ...
                return PixelData.FromBgra(average, average, average, 255);
            }
        }
            ...
            : UnaryPixelOp
        {
            public override PixelData Apply(PixelData color)
            {
                ...
                return PixelData.FromBgra(i, i, i, 255);
            }
            ...
            : UnaryPixelOp
        {
            ...
            public override PixelData Apply(PixelData color)
            {
                ...
                return PixelData.FromBgraClamped(
                    color.B + diff,
                    color.G + diff,
                    color.R + diff,
                    255);
            ...
            : UnaryPixelOp
        {
            ...
            public override PixelData Apply(PixelData color)
            {
                return PixelData.FromBgra(CurveB[color.B], CurveG[color.G], CurveR[color.R], 255);
            }
...
//            }
        ...
        public class Level
            : ChannelCurve,
              ICloneable
        {
            private PixelData colorInLow;
            public PixelData ColorInLow 
            {
                get 
                {
                    return colorInLow; 
            ...
            private PixelData colorInHigh;
            public PixelData ColorInHigh 
            {
                get 
                {
                    return colorInHigh;
            ...
            private PixelData colorOutLow;
            public PixelData ColorOutLow 
            {
                get 
                {
                    return colorOutLow;
            ...
            private PixelData colorOutHigh;
            public PixelData ColorOutHigh 
            {
                get 
                {
                    return colorOutHigh;
            ...
            public static Level AutoFromLoMdHi(PixelData lo, PixelData md, PixelData hi) 
            {
                ...
                return new Level(lo, hi, gamma, PixelData.Black, PixelData.White);
            }
            ...
            public Level(PixelData in_lo, PixelData in_hi, float[] gamma, PixelData out_lo, PixelData out_hi)
            {
                colorInLow = in_lo;
                colorInHigh = in_hi;
                colorOutLow = out_lo;
            ...
            public PixelData Apply(float r, float g, float b) 
            {
            ...
            public void UnApply(PixelData after, float[] beforeOut, float[] slopesOut) 
            {
            ...
            : UnaryPixelOp
        {
            ...
            public HueSaturationLightness(int hueDelta, int satDelta, int lightness)
            {
                ...
                {
                    blendOp = new UnaryPixelOps.BlendConstant(PixelData.FromBgra(255, 255, 255, (byte)((lightness * 255) / 100)));
                }
                else // if (lightness < 0)
                {
                    blendOp = new UnaryPixelOps.BlendConstant(PixelData.FromBgra(0, 0, 0, (byte)((-lightness * 255) / 100)));
                }
            }
			...
			public override PixelData Apply (PixelData color)
            {
				...
				PixelData newColor = PixelData.FromBgr((byte)rgbColor.Blue, (byte)rgbColor.Green, (byte)rgbColor.Red);
            ...
            : UnaryPixelOp
        {
            ...
            public override PixelData Apply(PixelData color)
            {
                return PixelData.FromBgra(blueLevels[color.B], greenLevels[color.G], redLevels[color.R], 255);
            }
